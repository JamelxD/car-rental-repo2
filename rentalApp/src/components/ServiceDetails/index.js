          ...
          <Col lg={12}>
            <div className="service-details-right">
              ...
              <div className="simple-text">
                ...
                {props.protection === 'standard-protection' ? <div><Icon name='minus' />Standard Protection: Cover for damage to tires, windshield, windows and theft cover.</div> : props.protection === 'full-protection' ? <div><Icon name='minus' />Full Protection:  Cover for damage to tires, windshield, windows, interior, theft cover and roadside assistance.</div> : props.protection === 'basic-protection' ? <div><Icon name='minus' />Basic Protection: This plan provides $75,000 in physical damage coverage as well as benefits for theft & vandalism. Offered and sold by Allianz Global Assistance. You can view more information <Link target="_blank" to={"https://www.allianztravelinsurance.com/"}> here</Link></div> : <></>}
