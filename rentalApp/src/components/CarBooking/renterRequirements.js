export const renterRequirements = () => {
    return (
        <div>
            <p>All drivers must present a full valid and unexpired driving licence. If the driving licence is written in a language and characters different to those of the country of rental, an International Driving Permit is also required. Renters are advised to check whether local authorities require foreign drivers to present an International Driving Permit to avoid the risk of potential fines. Renters with licences from countries who are not part of the International Driving Permit Agreement should carry a certified translation.<br />
