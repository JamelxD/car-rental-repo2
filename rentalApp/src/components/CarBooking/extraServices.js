export const extraServices = () => {
    return (
        <div>
            ...
            <p>included in the cost of your rental, or<br />
                ordered and paid for when booking your car, or<br />
                requested when booking your car and paid for at pick-up (in which case, we can&rsquo;t guarantee that they&rsquo;ll be available, or that the price will be the same).</p>
